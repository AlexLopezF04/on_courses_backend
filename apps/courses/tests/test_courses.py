...
from apps.helpers import create_user, create_professor, create_admin, auth_client, unauth_client
from apps.courses.tests.helpers import create_category, create_course
...
class CoursePermissionTests(TestCase):
    ...
    def test_student_cannot_create_course(self):
        resp = auth_client(self.student).post('/api/courses/', {
    ...
    def test_professor_can_create_course(self):
        resp = auth_client(self.prof).post('/api/courses/', {
            'category': self.cat.id,
