...
class Exam(models.Model):
    ...
    course = models.ForeignKey(
        Course, on_delete=models.CASCADE, related_name="exams", verbose_name="Curso"
    )
...
class ExamQuestion(models.Model):
    ...
    exam = models.ForeignKey(
        Exam, on_delete=models.CASCADE, related_name="exam_questions", verbose_name="Evaluación"
    )
