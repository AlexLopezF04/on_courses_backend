...
class LessonComment(models.Model):
    ...
    lesson = models.ForeignKey(
        Lesson, on_delete=models.CASCADE, related_name="comments", verbose_name="Lección"
    )
    author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="lesson_comments", verbose_name="Autor"
    )
